...
import { wallMaterials, insulationMaterials, windowTypes, roofMaterials, doorTypes } from "@/data/materials"
...
export default function ControlSidebar({ roomData, results, onUpdateRoomData }: ControlSidebarProps) {
  const getMaxWindows = () => {
    ...
    if (!roomData.adjacentAreas?.front) {
      ...
      availableWalls.push(Math.max(0, roomData.dimensions.length - roomData.door.width - 0.6)) // Door + margins
    }
          ...
          <div className="flex-1 overflow-hidden min-h-0">
            ...
            >
              ...
              <div className="bg-white rounded-lg p-2 border border-blue-200 flex-shrink-0">
                <h3 className="font-medium text-blue-900 mb-2 text-sm">Room Dimensions</h3>
                <div className="space-y-2">
                  <div>
                    ...
                    <Slider
                      ...
                      onValueChange={([value]) => onUpdateRoomData("dimensions", { length: value })}
                      min={2}
                      max={15}
                      step={0.5}
                      className="h-1"
                  ...
                  <div>
                    ...
                    <Slider
                      ...
                      onValueChange={([value]) => onUpdateRoomData("dimensions", { width: value })}
                      min={2}
                      max={15}
                      step={0.5}
                      className="h-1"
                  ...
                  <div>
                    ...
                    <Slider
                      ...
                      onValueChange={([value]) => onUpdateRoomData("dimensions", { height: value })}
                      min={2.2}
                      max={4}
                      step={0.1}
                      className="h-1"
              ...
              <div className="bg-white rounded-lg p-2 border border-blue-200 flex-shrink-0">
                <h3 className="font-medium text-blue-900 mb-2 text-sm">Adjacent Areas</h3>
                <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-2 gap-1">
                  {[
                    ...
                    <div key={key} className="flex items-center justify-between text-xs">
                      ...
                      <input
                        type="checkbox"
                        checked={roomData.adjacentAreas?.[key as keyof typeof roomData.adjacentAreas] || false}
                        onChange={(e) =>
              ...
              {/* Wall Configuration */}
              <div className="bg-white rounded-lg p-2 border border-blue-200 flex-shrink-0">
                <h3 className="font-medium text-blue-900 mb-2 text-sm">Wall Configuration</h3>
                <div className="space-y-2">
                  <div>
                    <Label className="text-xs text-gray-600">Material:</Label>
                    <Select
                      value={roomData.walls.material}
                      onValueChange={(value) => onUpdateRoomData("walls", { material: value })}
                    >
                  ...
                  <div>
                    ...
                    <Slider
                      ...
                      onValueChange={([value]) => onUpdateRoomData("walls", { thickness: value })}
                      min={0.1}
                      max={0.5}
                      step={0.01}
                      className="h-1"
                    ...
                    <Select
                      ...
                      onValueChange={(value) => {
                        onUpdateRoomData("walls", {
                          insulation: value,
                          insulationThickness: value === "none" ? 0 : roomData.walls.insulationThickness,
                        })
                      }}
                    >
                      <SelectTrigger className="mt-1 h-7 text-xs">
                  ...
                  {roomData.walls.insulation !== "none" && (
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        <Label className="text-xs text-gray-600">Insulation Thickness</Label>
                        <Badge variant="outline" className="text-xs">
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) => onUpdateRoomData("walls", { insulationThickness: value })}
                        min={0.01}
                        max={0.2}
                        step={0.01}
                        className="h-1"
            ...
            >
              ...
              <div className="bg-white rounded-lg p-2 border border-green-200 flex-shrink-0">
                <h3 className="font-medium text-green-900 mb-2 text-sm">Windows</h3>
                <div className="space-y-2">
                  <div>
                    <div className="flex justify-between items-center mb-1">
                    ...
                    <Slider
                      ...
                      onValueChange={([value]) => onUpdateRoomData("windows", { count: Math.round(value) })}
                      min={0}
                      max={maxWindows}
                      step={1}
                      className="h-1"
                  ...
                  {maxWindows === 0 && (
                    <div className="text-xs text-orange-600 bg-orange-50 p-2 rounded">
                      No windows can be placed. All available walls are adjacent areas.
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) => onUpdateRoomData("windows", { width: value })}
                        min={0.5}
                        max={3}
                        step={0.1}
                        className="h-1"
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) => onUpdateRoomData("windows", { height: value })}
                        min={0.5}
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => onUpdateRoomData("windows", { type: value })}
                    >
                      <SelectTrigger className="mt-1 h-7 text-xs">
                        <SelectValue />
                      </SelectTrigger>
              ...
              {/* Door Configuration */}
              <div className="bg-white rounded-lg p-2 border border-green-200 flex-shrink-0">
                <h3 className="font-medium text-green-900 mb-2 text-sm">Door (Always on Front Wall)</h3>
                <div className="space-y-2">
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <div className="flex justify-between items-center mb-1">
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) => onUpdateRoomData("door", { width: value })}
                        min={0.7}
                        max={1.2}
                        step={0.1}
                        className="h-1"
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) => onUpdateRoomData("door", { height: value })}
                        min={1.8}
                        max={2.5}
                        step={0.1}
                        className="h-1"
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => onUpdateRoomData("door", { type: value })}
                    >
                      <SelectTrigger className="mt-1 h-7 text-xs">
                        <SelectValue />
                      </SelectTrigger>
            ...
            >
              ...
              <div className="bg-white rounded-lg p-2 border border-purple-200 flex-shrink-0">
                <h3 className="font-medium text-purple-900 mb-2 text-sm">Roof Configuration</h3>
                <div className="space-y-2">
                  <div>
                    <Label className="text-xs text-gray-600">Material:</Label>
                    <Select
                      value={roomData.roof.material}
                      onValueChange={(value) => onUpdateRoomData("roof", { material: value })}
                    >
                      <SelectTrigger className="mt-1 h-7 text-xs">
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Slider
                      ...
                      onValueChange={([value]) => onUpdateRoomData("roof", { thickness: value })}
                      min={0.1}
                      max={0.5}
                      step={0.01}
                      className="h-1"
                    ...
                    <Select
                      ...
                      onValueChange={(value) => {
                        onUpdateRoomData("roof", {
                          insulation: value,
                          insulationThickness: value === "none" ? 0 : roomData.roof.insulationThickness,
                        })
                      }}
                    >
                      <SelectTrigger className="mt-1 h-7 text-xs">
                  ...
                  {roomData.roof.insulation !== "none" && (
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) => onUpdateRoomData("roof", { insulationThickness: value })}
                        min={0.01}
                        max={0.3}
                        step={0.01}
                        className="h-1"
              ...
              {/* Floor Info */}
              <div className="bg-white rounded-lg p-2 border border-purple-200 flex-shrink-0">
                <h3 className="font-medium text-purple-900 mb-1 text-sm">Floor</h3>
                <div className="text-xs text-gray-600 space-y-1">
                  <div>• Area: {(roomData.dimensions.length * roomData.dimensions.width).toFixed(1)}m²</div>
                  <div>
                    • Dimensions: {roomData.dimensions.length}m × {roomData.dimensions.width}m
                  </div>
              ...
              {results && (
                <div className="bg-white rounded-lg p-2 border border-purple-200 flex-shrink-0">
                  <h3 className="font-medium text-purple-900 mb-1 text-sm">Performance</h3>
                  <div className="text-xs text-gray-600 space-y-1">
                    <div>• U-Value: {results.currentUValue.toFixed(2)} W/m²·K</div>
                    <div>• Heat Loss: {results.currentHeatLoss.toFixed(0)} W</div>
